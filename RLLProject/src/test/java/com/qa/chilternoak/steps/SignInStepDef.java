...
import com.qa.chilternoak.pageObjects.SignInPage;
...
public class SignInStepDef {
	...
	SignInPage sp = new SignInPage(SignupHooks.driver);
	
	
	@Given("I am on the Furniture Website HomePage")
	public void i_am_on_the_furniture_website_home_page() {
		sp = PageFactory.initElements(SignupHooks.driver, SignInPage.class);
		SignupHooks.driver.get("https://www.chilternoakfurniture.co.uk/");
	}
	...
	public void i_click_on_sign_in_button()  {
	    ...
	    WebDriverWait wait = new WebDriverWait(SignupHooks.driver, Duration.ofSeconds(12000));
